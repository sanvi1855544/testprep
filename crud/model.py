...
def model_tester():
    ...
    u2 = Users(name='Shruti Chari', email='shrutijchari@gmail.com', password='shrutijc!', phone="8587508311")
    u3 = Users(name='Gennalyn Bongalan', email='gennalyn@live.com', password='123genn', phone="8587765096")
